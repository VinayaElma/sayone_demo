...
urlpatterns = [
    ...
    re_path(r'^boards/(?P<pk>[0-9]+)/topics/(?P<topic_pk>[0-9]+)/$', views.topic_posts, name='topic_posts'),
    re_path(r'^boards/(?P<pk>[0-9]+)/topics/(?P<topic_pk>[0-9]+)/reply/$', views.reply_topic, name='reply_topic'),
